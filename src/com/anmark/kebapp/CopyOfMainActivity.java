...
public class CopyOfMainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isInternetPresent) {
			...
			alert.showAlertDialog(CopyOfMainActivity.this, "Internet Connection Error",
		...
		if (gps.canGetLocation()) {
			...
			alert.showAlertDialog(CopyOfMainActivity.this, "GPS Status",
	...
	class LoadPlaces extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CopyOfMainActivity.this);
				...
				public void run() {
					...
					if(status.equals("OK")){
						...
						if (nearPlaces.results != null) {
							...
							// list adapter
							ListAdapter adapter = new SimpleAdapter(CopyOfMainActivity.this, placesListItems,
									R.layout.list_item,
						...
						// Zero results found
						alert.showAlertDialog(CopyOfMainActivity.this, "Near Places",
								"Sorry no places found. Try to change the types of places",
								false);
					}
					else if(status.equals("UNKNOWN_ERROR"))
					{
						alert.showAlertDialog(CopyOfMainActivity.this, "Places Error",
